 ...
 * file: app/src/main/java/org/jellyfin/mobile/player/deviceprofile/CodecHelpers.kt
 *
 * jellyfin-android is licensed under GPL-2.0; Findroid is likewise GPL-licensed,
 * so this port is compatible. The subtitle mime-type helper from the original
 * was dropped — Findroid does its own subtitle mime mapping in the player module.
 */
